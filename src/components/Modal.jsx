...
const ModalItem = ({title, to, onClick }) => {
  return (
    <Link to={to} onClick={onClick}>
      <div className="flex justify-center flex-col text-blue h-14 border-bottom hover:text-olive md:text-xl">
        {title}
      </div>
    </Link>
  )
...
const Modal = ({ closeModal }) => {
  return (
    <>
      <div className='absolute top-20 left-[40px] w-[150px] md:w-[250px] bg-sand rounded-lg p-3'>
